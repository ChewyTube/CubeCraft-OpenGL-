...
int main()
{
    ...
    */
    ...
    // 窗口
    GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "CubeCraft", NULL, NULL);
    if (window == NULL)
    {
    ...
    unsigned char* data = stbi_load("Scr/Texture/test.png", &width, &height, &nrChannels, 0);
    if (data)
    {
